...
const datenschutz = () => {
  return (
    <main>
      <Heading title="Datenschutz" />
      <div className="content">
        Allgemeiner Hinweis und Pflichtinformationen Benennung der
        verantwortlichen Stelle Die verantwortliche Stelle für die
        Datenverarbeitung auf dieser Website ist: Name der Firma Christian
        Grothe Hermannstr. 171 12051 Berlin Die verantwortliche Stelle
        ...
        und am Schloss-Symbol in der Browserzeile. Kontaktformular Per
        ...
        Aufbewahrungsfristen - bleiben unberührt. Newsletter-Daten Zum Versenden
        unseres Newsletters benötigen wir von Ihnen eine E-Mail-Adresse. Eine
        ...
        ausschließlich für den Versand des Newsletters. Die bei der
        ...
        unberührt. Zur Einrichtung des Abonnements eingegebene Daten werden im
        Falle der Abmeldung gelöscht. Sollten diese Daten für andere Zwecke und
        an anderer Stelle an uns übermittelt worden sein, verbleiben diese
        weiterhin bei uns. YouTube Für Integration und Darstellung von
        Videoinhalten nutzt unsere Website Plugins von YouTube. Anbieter des
        Videoportals ist die YouTube, LLC, 901 Cherry Ave., San Bruno, CA 94066,
        USA. Bei Aufruf einer Seite mit integriertem YouTube-Plugin wird eine
        ...
        Surfverhalten direkt Ihrem persönlichen Profil zuzuordnen, sollten Sie
        in Ihrem YouTube Konto eingeloggt sein. Durch vorheriges Ausloggen haben
        Sie die Möglichkeit, dies zu unterbinden. Die Nutzung von YouTube
        ...
        Art. 6 Abs. 1 lit. f DSGVO dar. Einzelheiten zum Umgang mit Nutzerdaten
        finden Sie in der Datenschutzerklärung von YouTube unter:
        https://www.google.de/intl/de/policies/privacy. Quelle:
